...
import defImg from "@/images/news-default.jpg";
...
const LeadershipPhilosophyAdd: React.FC<{category: string}> = ({category}) => {
    ...
    //         .then(blob => methods.setValue('image',
    //             new File([blob], 'news-default.jpg', {
    //                 type: blob.type,
    //             })
    //         ));
    // }, []);
    ...
    const onSubmit =  () => {
        ...
        // console.log('submit: ', methods.getValues('image'));
...
export default LeadershipPhilosophyAdd;
