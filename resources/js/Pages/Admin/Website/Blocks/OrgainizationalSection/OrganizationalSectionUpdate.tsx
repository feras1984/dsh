...
const OrganizationalSectionUpdate: React.FC<{category: string, block: Block}> = ({category, block}) => {
    ...
    return (
        <Box>
            <Breadcrumbs>
                <Link href={`/admin/website/get-block/` + block.category}>Back to {commonService.toTitleCase(block.category)}</Link>
...
export default OrganizationalSectionUpdate;
