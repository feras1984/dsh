...
const OrganizationalSectionAdd: React.FC<{category: string}> = ({category}) => {
    ...
    return (
        <Box>
            <Breadcrumbs>
                <Link href={`/admin/website/get-block/` + category}>Back to {commonService.toTitleCase(category)}</Link>
...
export default OrganizationalSectionAdd;
