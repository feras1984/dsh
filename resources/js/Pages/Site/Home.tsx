            ...
            <HeaderLayout
             ...
             >
                ...
                <Box className={styles.mainContainer}>
                    <Box className="relative" ref={mainSliderRef}>
                        <MainSlider mainSliders={mainSliders}></MainSlider>
                        <Box className={`newsBanner ${styles.newsBanner}`}>
                            <News blocks={news}></News>
                        </Box>
                        {/*<SiteDivider></SiteDivider>*/}
                    </Box>
                </Box>


                {/*<Box ref={aboutRef} className={`mt-[-8%]`}>*/}
                {/*    <About blocks={about}></About>*/}
                {/*</Box>*/}

                <Box className="relative">
                    <Articles blocks={articles.filter((article, index) => index < 3)}></Articles>
                </Box>

                <Box className={`relative ${styles.industriesBg}`}>
                    <Box className="py-[32px]">
                        <Industries blocks={industries.filter((industry, index) => index < 3)}></Industries>
                    </Box>
                </Box>

                <Box className="relative">
                    <Services blocks={services}></Services>
                </Box>
                ...
                {/*<Box className="m-[32px]">*/}
                {/*    <LineDividerReverse></LineDividerReverse>*/}
                {/*</Box>*/}
                ...
                {/*<Box>*/}
                {/*    <Galleries blocks={galleries.filter((gallery, key) => key < 3)}></Galleries>*/}
                {/*</Box>*/}
                ...
                <Box className="my-[32px]"></Box>

                {/*<Box>*/}
                {/*    <Mission blocks={about}></Mission>*/}
                {/*</Box>*/}
