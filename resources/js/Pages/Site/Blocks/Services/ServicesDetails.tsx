...
import {Avatar, Box, Card, CardHeader, CardMedia, CardContent, IconButton, BoxProps, Typography} from "@mui/material";
...
const ServicesDetails: React.FC<{service: BlockProps}> = ({service}) => {
