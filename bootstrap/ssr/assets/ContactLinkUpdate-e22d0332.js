...
import { V as ValidatedSelect, B as BasicTitleTranslation } from "./BasicTitleTranslation-6327a4f2.js";
...
const ContactLinkUpdate = ({ category, menus, menu }) => {
  ...
  const [linkType, setLinkType] = React.useState(menu.type);
