...
import ClientsList from "./ClientsList-0f5cc818.js";
import GalleryList from "./GalleryList-4d4b33a5.js";
import ServicesList from "./ServicesList-092d1293.js";
import Contact from "./Contact-819367c5.js";
import { Head } from "@inertiajs/react";
import { Box } from "@mui/material";
import { H as HeaderLayout } from "./HeaderLayout-dd753ddf.js";
...
import "./SectionTitle-76ecd5f3.js";
/* empty css                     */import "@mui/material/styles/index.js";
import "./styles.module-528aad3a.js";
import "gsap";
import "@gsap/react";
...
const HubList = ({
  ...
  switch (commonService.toTitleCase(category)) {
    ...
    case BlockCategories.CLIENTS: {
      AddComponent = () => /* @__PURE__ */ jsx(ClientsList, { clients: blocks });
      break;
    }
    ...
    case BlockCategories.CONTACT_US: {
      AddComponent = () => /* @__PURE__ */ jsx(Contact, { contact: blocks });
      break;
    }
