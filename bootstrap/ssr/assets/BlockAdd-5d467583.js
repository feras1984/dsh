...
import MainSectionAdd from "./MainSectionAdd-0c608463.js";
import AboutAdd from "./AboutAdd-2d81282a.js";
import ClientsAdd from "./ClientsAdd-ff3baa01.js";
import GalleryAdd from "./GalleryAdd-ea203537.js";
import MissionAdd from "./MissionAdd-e62718ec.js";
import ServicesAdd from "./ServicesAdd-8a6a037f.js";
import StoreSectionAdd from "./StoreSectionAdd-fb11a469.js";
import NewsAdd from "./NewsAdd-f36dbbea.js";
import IndustriesAdd from "./IndustriesAdd-04480ec6.js";
import ArticlesAdd from "./ArticlesAdd-10c89465.js";
import GeneralDirectorAdd from "./GeneralDirectorAdd-a4b2f532.js";
import ProjectsAdd from "./ProjectsAdd-e00163ee.js";
import ManagerProfileAdd from "./ManagerProfileAdd-dab53a2f.js";
import LeadershipPhilosophyAdd from "./LeadershipPhilosophyAdd-73d0ca54.js";
import VisionAdd from "./VisionAdd-29bef418.js";
import CoreValuesAdd from "./CoreValuesAdd-6f2bbe6a.js";
import PrincipalActivitiesAdd from "./PrincipalActivitiesAdd-c5e5bca2.js";
import QualityAssuranceAdd from "./QualityAssuranceAdd-9ce65f1b.js";
import SafetyPlanningAdd from "./SafetyPlanningAdd-188b3b6f.js";
import CompanyThoughtsAdd from "./CompanyThoughtsAdd-79b43eed.js";
import OrganizationalSectionAdd from "./OrganizationalSectionAdd-53cafee2.js";
import "react";
import "@mui/material";
...
const BlockAdd = ({ category }) => {
  ...
  switch (commonService.toTitleCase(category)) {
    ...
    case BlockCategories.PRINCIPAL_ACTIVITIES: {
      AddComponent = () => /* @__PURE__ */ jsx(PrincipalActivitiesAdd, { category });
      break;
    }
    case BlockCategories.QUALITY_ASSURANCE: {
      AddComponent = () => /* @__PURE__ */ jsx(QualityAssuranceAdd, { category });
      break;
    }
    case BlockCategories.SAFETY_PLANNING: {
      AddComponent = () => /* @__PURE__ */ jsx(SafetyPlanningAdd, { category });
      break;
    }
    case BlockCategories.COMPANY_THOUGHTS: {
      AddComponent = () => /* @__PURE__ */ jsx(CompanyThoughtsAdd, { category });
      break;
    }
    ...
    case BlockCategories.ORGANIZATIONAL_SECTION: {
      AddComponent = () => /* @__PURE__ */ jsx(OrganizationalSectionAdd, { category });
      break;
    }
    default: {
      AddComponent = () => /* @__PURE__ */ jsx(MainSectionAdd, { category });
