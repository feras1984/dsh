...
import { d as defImg } from "./news-default-e98e3324.js";
...
const IndustriesAdd = ({ category }) => {
  ...
  React.useEffect(() => {
    fetch(defImg).then((response) => response.blob()).then((blob) => methods.setValue(
      "image",
