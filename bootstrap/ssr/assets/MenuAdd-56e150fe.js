...
import { M as MenuCategories, A as AdminLayout } from "./AdminLayout-17525961.js";
import { Head } from "@inertiajs/react";
import MainLinkAdd from "./MainLinkAdd-24c77262.js";
import SocialLinkAdd from "./SocialLinkAdd-1195baa7.js";
import FooterAdd from "./FooterAdd-916227ba.js";
import ContactLink from "./ContactLinkAdd-c4679b98.js";
import "axios";
...
import "./ValidatedSelectWithIcon-0fc8a7a2.js";
import "./SocialMenuEnum-5925d08f.js";
import "./ContactEnum-89ec9065.js";
const MenuAdd = ({ category, menus }) => {
  const commonService = Container.get(CommonService);
  Object.values(MenuCategories);
  let AddComponent;
  switch (commonService.toTitleCase(category)) {
    case MenuCategories.MAIN_MENU: {
      AddComponent = () => /* @__PURE__ */ jsx(MainLinkAdd, { category, menus });
      break;
    }
    case MenuCategories.SOCIAL_MENU: {
      AddComponent = () => /* @__PURE__ */ jsx(SocialLinkAdd, { category, menus });
      break;
    }
    case MenuCategories.FOOTER_MENU: {
      AddComponent = () => /* @__PURE__ */ jsx(FooterAdd, { category, menus });
      break;
    }
    case MenuCategories.CONTACT_MENU: {
      AddComponent = () => /* @__PURE__ */ jsx(ContactLink, { category, menus });
      break;
    }
    default: {
      AddComponent = () => /* @__PURE__ */ jsx(MainLinkAdd, { category, menus });
