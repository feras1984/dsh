...
import { A as AdminLayout } from "./AdminLayout-17525961.js";
import { B as BlockCategories } from "./BlockCategories-4588e507.js";
import MainSectionUpdate from "./MainSectionUpdate-cd58956a.js";
import AboutUpdate from "./AboutUpdate-8cff68f7.js";
import ClientsUpdate from "./ClientsUpdate-3f310735.js";
import GalleryUpdate from "./GalleryUpdate-5881424a.js";
import MissionUpdate from "./MissionUpdate-78775643.js";
import ServicesUpdate from "./ServicesUpdate-ad8681ef.js";
import StoreSectionUpdate from "./StoreSectionUpdate-ceb1be75.js";
import NewsUpdate from "./NewsUpdate-04fae5fe.js";
import ArticlesUpdate from "./ArticlesUpdate-c8211b0d.js";
import IndustriesUpdate from "./IndustriesUpdate-12d5d77d.js";
import GeneralDirectorUpdate from "./GeneralDirectorUpdate-db98e2d1.js";
import ProjectsUpdate from "./ProjectsUpdate-d66bf3c6.js";
import ManagerProfileUpdate from "./ManagerProfileUpdate-73b4405b.js";
import LeadershipPhilosophyUpdate from "./LeadershipPhilosophyUpdate-055e388f.js";
import VisionUpdate from "./VisionUpdate-92b4e716.js";
import CoreValuesUpdate from "./CoreValuesUpdate-e9ef2e7c.js";
import PrincipalActivitiesUpdate from "./PrincipalActivitiesUpdate-83c56423.js";
import QualityAssuranceUpdate from "./QualityAssuranceUpdate-354a6c27.js";
import SafetyPlanningUpdate from "./SafetyPlanningUpdate-f0e36cb6.js";
import CompanyThoughtsUpdate from "./CompanyThoughtsUpdate-0edad0c4.js";
import OrganizationalSectionUpdate from "./OrganizationalSectionUpdate-9e829a73.js";
import "axios";
...
import "./ValidatedImage-2091d3e0.js";
import "./FileService-5953256c.js";
import "./BasicTranslation-32e41136.js";
...
const BlockUpdate = ({ category, block }) => {
  ...
  switch (commonService.toTitleCase(category)) {
    ...
    case BlockCategories.VISION: {
      UpdateComponent = () => /* @__PURE__ */ jsx(VisionUpdate, { block, category });
      break;
    }
    case BlockCategories.CORE_VALUES: {
      UpdateComponent = () => /* @__PURE__ */ jsx(CoreValuesUpdate, { block, category });
      break;
    }
    ...
    case BlockCategories.GENERAL_DIRECTOR_SPEECH: {
      UpdateComponent = () => /* @__PURE__ */ jsx(GeneralDirectorUpdate, { block, category });
      break;
    }
    case BlockCategories.MANAGER_PROFILE: {
      UpdateComponent = () => /* @__PURE__ */ jsx(ManagerProfileUpdate, { block, category });
      break;
    }
    case BlockCategories.LEADERSHIP_PHILOSOPHY: {
      UpdateComponent = () => /* @__PURE__ */ jsx(LeadershipPhilosophyUpdate, { block, category });
      break;
    }
    case BlockCategories.PROJECTS: {
      UpdateComponent = () => /* @__PURE__ */ jsx(ProjectsUpdate, { block, category });
      break;
    }
    case BlockCategories.PRINCIPAL_ACTIVITIES: {
      UpdateComponent = () => /* @__PURE__ */ jsx(PrincipalActivitiesUpdate, { block, category });
      break;
    }
    case BlockCategories.QUALITY_ASSURANCE: {
      UpdateComponent = () => /* @__PURE__ */ jsx(QualityAssuranceUpdate, { block, category });
      break;
    }
    case BlockCategories.SAFETY_PLANNING: {
      UpdateComponent = () => /* @__PURE__ */ jsx(SafetyPlanningUpdate, { block, category });
      break;
    }
    case BlockCategories.COMPANY_THOUGHTS: {
      UpdateComponent = () => /* @__PURE__ */ jsx(CompanyThoughtsUpdate, { block, category });
      break;
    }
    case BlockCategories.ORGANIZATIONAL_SECTION: {
      UpdateComponent = () => /* @__PURE__ */ jsx(OrganizationalSectionUpdate, { block, category });
      break;
    }
    default: {
      UpdateComponent = () => /* @__PURE__ */ jsx(MainSectionUpdate, { block, category });
