...
const BlockReorder = ({ category, blocks }) => {
  ...
  const [left, setLeft] = React.useState(blocks);
  ...
  const customList = (items) => /* @__PURE__ */ jsx(Paper, { sx: { width: 200, height: 230, overflow: "auto" }, children: /* @__PURE__ */ jsx(List, { dense: true, component: "div", role: "list", children: items.map((block, index) => {
    ...
    return /* @__PURE__ */ jsxs(
      ListItemButton,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(ListItemText, { id: labelId, primary: blockService.getBlockName(block) })
        ]
      },
      blockService.getBlockName(block)
    );
  }) }) });
  const reorder = () => {
    if (left.length > 0) {
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { children: [
    ...
    /* @__PURE__ */ jsx(Box, { className: "py-[16px]", children: /* @__PURE__ */ jsx(
      Stack,
      {
        ...
        alignItems: "center",
        spacing: 2,
        children: /* @__PURE__ */ jsx(Link, { href: `/admin/website/get-block/${category}`, children: /* @__PURE__ */ jsx(CustomButton, { task: "back", text: "to list" }) })
      }
    ) }),
